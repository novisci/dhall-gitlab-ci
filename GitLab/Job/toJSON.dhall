    ...
    = λ(job : Job) →
        let everything
            ...
            = toMap
                ...
                , variables = Some
                    ( JSON.object
                        (Map.map Text Text JSON.Type JSON.string job.variables)
                    )
                , rules =
                ...
                , tags =
                    Optional/map (List Text) JSON.Type stringsArrayJSON job.tags
                ...
                , services =
                    let servicesList = optionalList Service.Type job.services
                ...
                , artifacts =
                    Optional/map
                      ...
                      job.artifacts
                , resource_group =
                    Optional/map Text JSON.Type JSON.string job.resource_group
                , environment =
                    Optional/map
                      Environment.Type
                      JSON.Type
                ...
                , trigger =
                    Optional/map
                      ...
                      Trigger.toJSON
                      job.trigger
                , timeout = Optional/map Text JSON.Type JSON.string job.timeout
                }
